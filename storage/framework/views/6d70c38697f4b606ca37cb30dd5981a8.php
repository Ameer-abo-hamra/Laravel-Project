...
<body>
    ...
    <div class="all-medicines">
        ...
        <?php if(count($medicinesGroupedByCategory) == 0): ?>
            <h3>
        ...
        <?php else: ?>
            <div class="items">
                ...
                <?php $__currentLoopData = $medicinesGroupedByCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <h2><?php echo e($key); ?> : </h2>
                    <div class="parent">
                        <?php $__currentLoopData = $value; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $arr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="medicine">
                          <div class="top">
                            <h3> <?php echo e($arr->t_name); ?></h3>
                            <div class="det">
                                <p>
                                    The scientific name is :
                                </p>
                                <span><?php echo e($arr->s_name); ?></span>
                            </div>
                            <div class="det">
                                <p>
                                    price :
                                </p>
                                <span> <?php echo e($arr->price); ?></span>
                            </div>
                            <div class="det">
                                <p>
                                    amount :
                                </p>
                                <span><?php echo e($arr->amount); ?></span>
                            </div>
                            <div class="det">
                                <p>
                                    category :
                                </p>
                                <span><?php echo e($arr->category); ?></span>
                            </div>
                            <div class="det">
                                <p>
                                    company :
                                </p>
                                <span><?php echo e($arr->company); ?></span>
                            </div>
                          </div>
                                <div class="bottom">
                                    <ul>
...
<?php /**PATH D:\course laravel\testERD\resources\views/allMedicines.blade.php ENDPATH**/ ?>