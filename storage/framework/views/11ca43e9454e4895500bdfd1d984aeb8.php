    ...
    <div class="add-medicine">
        ...
        <div class="form">
            ...
            <?php if(session('success')): ?>
                <h3 id="success"><?php echo e(session('success')); ?> </h3>
            <?php endif; ?>
            ...
            <form action="<?php echo e(route('add.medicine')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="s_name">
...
<?php /**PATH D:\course laravel\testERD\resources\views/AddMedicine.blade.php ENDPATH**/ ?>