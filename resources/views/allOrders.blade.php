                ...
                <tbody>
                    @foreach ($orders as $order)
                        <tr>
                            <td id="parentCheck">
                                {{ $order->id }}
                                <i class="fa-solid fa-check" id="insideId{{ $order->id }}"></i>
                            </td>

                            <td>
                                <select name="state" id="state{{ $order->id }}">
                                    ...
                                    @elseif ($order->state == 'done')
                                        ...
                                        <option value="not done">not done</option>
                                    @else
                                        <option value="{{ $order->state }} " selected>{{ $order->state }}
                                        </option>
                                        <option value="preparation">preparation</option>
                                        <option value="done">done</option>
                                    @endif
                            ...
                            <td>
                                <select name="payed" id="payed{{ $order->id }}">
                            ...
                            <td>
                                <button class="btn" value="update" onclick="update({{ $order->id }})">
                                    update</button>
                            </td>
                        </tr>
                    @endforeach
